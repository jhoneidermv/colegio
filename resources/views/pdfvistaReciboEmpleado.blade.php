...
<body background="../images/reciboEmpleado.png"  style="width:900px;height:900px;background-repeat: no-repeat; background-position: left left" > 
...
<table style="margin-top:-30px;margin-left:67px;">
        ...
        <tr >
            <th style="padding: 3px 3px;color: #5D6975;width:50%;white-space: nowrap;font-weight: normal;" >{{$user->valorMens}}</th>
        </tr>
        <tr>
            <th style="padding: 7px 3px;color: #5D6975;width:50%;white-space: nowrap;font-weight: normal;">{{$user->valorAdicional}}</th>
        </tr>
        <tr>
            <th style="padding: 7px 3px;color: #5D6975;width:50%;white-space: nowrap;font-weight: normal;" >{{$user->valorDescuento}}</th>
        </tr>
        <tr>
 ...
 <table style="margin-top:-250px;margin-left:330px;">
        ...
        <tr style="padding:2px;0px;">
            <th style="padding: 10px 3px;color: #5D6975;width:50%;white-space: nowrap;font-weight: normal;">{{$user->valorMens}}</th>
        </tr>
        <tr>
            <th style="padding: 7px 3px;color: #5D6975;width:50%;white-space: nowrap;font-weight: normal;">{{$user->valorAdicional}}</th>
        </tr>
        ...
        <tr>
            <th style="padding: 5px 3px;color: #5D6975;width:50%;white-space: nowrap;font-weight: normal;" >{{$user->Observaciones}}</th>
        </tr>
